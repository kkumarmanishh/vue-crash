...
<template>
    <section class="bg-green-50">
        <div class="container m-auto max-w-2xl py-24">
            <div class="bg-white px-6 py-8 mb-4 shadown-md rounded-md m-4 md:m-0">
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="mb-4">
                        ...
                        <select v-model="form.type" name="type" id="type" class="border border-gray-300 rounded w-full py-2">
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.title" type="text" name="name" id="name" class="border border-gray-300 rounded w-full py-2 px-3 mb-2"
                            placeholder="eg. Software Developer" required />
                    </div>

                    <div class="mb-4">
                        <label for="description" class="block text-gray-700 font-bold mb-2">Description</label>
                        <textarea v-model="form.description" name="description" id="description" class="border border-gray-300 rounded w-full px-3 py-2" rows="4"
                    ...
                    <div class="mb-4">
                        ...
                        <select v-model="form.salary" name="salary" id="salary" class="border border-gray-300 rounded w-full py-2 px-3" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.location" type="text" name="location" id="location" class="border border-gray-300 rounded w-full py-2 px-3 mb-2"
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.company.name" type="text" id="company" name="company" class="border border-gray-300 rounded w-full py-2 px-3 mb-2" />
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.company.contactEmail" type="email" id="contact_email" name="contact_email"
                            class="border border-gray-300 rounded w-full py-2 px-3" placeholder="Email address for applicants"
                            required />
                    </div>
                    <div class="mb-4">
                        ...
                        <input v-model="form.company.contactPhone" type="tel" id="contact_phone" name="contact_phone"
                            class="border border-gray-300 rounded w-full py-2 px-3" placeholder="Optional phone for applicants" />
                    </div>
