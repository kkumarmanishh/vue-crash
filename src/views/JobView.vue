            ...
            <div class="grid grid-cols-1 md:grid-cols-[70%_30%] w-full gap-6">
                <main>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md mt-6">
                        ...
                        <h3 class="text-green-800 text-lg font-boldd mb-2">Salary</h3>
                ...
                <aside>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md mt-6">
                        <h3 class="text-xl font-bold mb-">Manage Job</h3>
                        <RouterLink :to="`/jobs/edit/${state.job.id}`"
                            class="bg-green-600 text-white
                        text-center font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block">Edit
                            Job</RouterLink>
                        <button @click="deleteJob"
                            class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shaadow-outline mt-4 block">Delete
                            Job</button>
                    </div>
                </aside>
            </div>
